...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-mgmt-network-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-mgmt-network-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-mgmt-network
# for installing globally
pixi global install azure-mgmt-network
```
...
It is possible to list all of the versions of `azure-mgmt-network` available on your platform:
...
```
pixi search azure-mgmt-network --channel conda-forge
```
